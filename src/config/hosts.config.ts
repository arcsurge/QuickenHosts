import { AnyObject, QuickenGroup } from "@/types/global";
...
export const hostsConfig: AnyObject = {
    ...
    osMap: {
        ...
        win32: {
            ...
            copyFile: 'echo F | xcopy /y',
            copyDir: 'echo D | xcopy /e /y /k',
            flushDns: 'ipconfig /flushdns'
        }
    }
}

export const quickenConfigs: QuickenGroup[] = [{
    name: 'default',
    list: [
...
export const { path, flushDns, copyFile, copyDir } = hostsConfig.osMap[platform]
